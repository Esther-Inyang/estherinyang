    ...
    <div>
      <div className="relative bg-[#011b3e] px-10 pt-14 pb-10 xl:pt-20 md:pb-20 flex gap-10 flex-col items-center justify-center">
        <h1
          data-aos="fade-up"
          data-aos-delay="300"
          className="w-[85%] md:w-[50%] lg:w-[40%] mx-auto text-xl xl:text-2xl font-extrabold text-white text-center"
        >
        ...
        <p
          data-aos="zoom-in"
          data-aos-delay="400"
          className="md:w-[70%] text-base xl:text-lg text-center font-light text-gray-200"
        >
